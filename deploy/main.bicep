...
@description('Indicates whether to deploy the storage account for irinchide manuals.')
...
var appServiceAppName = 'irinchide-website-${resourceNameSuffix}'
var appServicePlanName = 'irinchide-website-plan'
var MsYamlIrinaStorageAccountName = 'irinchideweb${resourceNameSuffix}'
